...
import com.sundy.rocketmq.logging.inner.Appender.AppenderPipeline;
import com.sundy.rocketmq.logging.inner.Appender.AppenderPipelineImpl;

public class Logger implements AppenderPipeline {
	...
	AppenderPipelineImpl appenderPipeline;
