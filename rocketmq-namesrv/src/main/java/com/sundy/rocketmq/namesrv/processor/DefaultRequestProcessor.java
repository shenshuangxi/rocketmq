...
import com.sundy.rocketmq.common.MQVersion.Version;
...
import com.sundy.rocketmq.common.namesrv.RegisterBrokerResult;
import com.sundy.rocketmq.common.protocol.RequestCode;
import com.sundy.rocketmq.common.protocol.ResponseCode;
import com.sundy.rocketmq.common.protocol.body.RegisterBrokerBody;
import com.sundy.rocketmq.common.protocol.body.TopicConfigSerializeWrapper;
import com.sundy.rocketmq.common.protocol.header.DeleteKVConfigRequestHeader;
import com.sundy.rocketmq.common.protocol.header.DeleteTopicInNamesrvRequestHeader;
import com.sundy.rocketmq.common.protocol.header.GetKVConfigRequestHeader;
import com.sundy.rocketmq.common.protocol.header.GetKVConfigResponseHeader;
import com.sundy.rocketmq.common.protocol.header.GetKVListByNamespaceRequestHeader;
import com.sundy.rocketmq.common.protocol.header.GetRouteInfoRequestHeader;
import com.sundy.rocketmq.common.protocol.header.GetTopicsByClusterRequestHeader;
import com.sundy.rocketmq.common.protocol.header.PutKVConfigRequestHeader;
import com.sundy.rocketmq.common.protocol.header.QueryDataVersionRequestHeader;
import com.sundy.rocketmq.common.protocol.header.QueryDataVersionResponseHeader;
import com.sundy.rocketmq.common.protocol.header.RegisterBrokerRequestHeader;
import com.sundy.rocketmq.common.protocol.header.RegisterBrokerResponseHeader;
import com.sundy.rocketmq.common.protocol.header.UnRegisterBrokerRequestHeader;
import com.sundy.rocketmq.common.protocol.header.WipeWritePermOfBrokerRequestHeader;
import com.sundy.rocketmq.common.protocol.header.WipeWritePermOfBrokerResponseHeader;
...
public class DefaultRequestProcessor implements NettyRequestProcessor {
	...
	public RemotingCommand registerBrokerWithFilterServer(ChannelHandlerContext ctx, RemotingCommand request) throws RemotingCommandException {
		...
		RegisterBrokerResult result = this.namesrvController.getRouteInfoManager().registerBroker(requestHeader.getClusterName(), requestHeader.getBrokerAddr(), requestHeader.getBrokerName(),
				requestHeader.getBrokerId(), requestHeader.getHaServerAddr(), registerBrokerBody.getTopicConfigSerializeWrapper(), registerBrokerBody.getFilterServerList(), ctx.channel());
	...
	public RemotingCommand registerBroker(ChannelHandlerContext ctx, RemotingCommand request) throws RemotingCommandException {
		...
		RegisterBrokerResult result = this.namesrvController.getRouteInfoManager().registerBroker(requestHeader.getClusterName(), requestHeader.getBrokerAddr(), requestHeader.getBrokerName(),
				requestHeader.getBrokerId(), requestHeader.getHaServerAddr(), topicConfigWrapper, null, ctx.channel());
