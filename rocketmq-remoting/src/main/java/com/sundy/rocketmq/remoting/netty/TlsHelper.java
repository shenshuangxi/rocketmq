...
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.TLS_CLIENT_AUTHSERVER;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.TLS_CLIENT_CERTPATH;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.TLS_CLIENT_KEYPASSWORD;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.TLS_CLIENT_KEYPATH;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.TLS_CLIENT_TRUSTCERTPATH;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.TLS_SERVER_AUTHCLIENT;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.TLS_SERVER_CERTPATH;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.TLS_SERVER_KEYPASSWORD;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.TLS_SERVER_KEYPATH;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.TLS_SERVER_NEED_CLIENT_AUTH;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.TLS_SERVER_TRUSTCERTPATH;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.TLS_TEST_MODE_ENABLE;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.tlsClientAuthServer;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.tlsClientCertPath;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.tlsClientKeyPassword;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.tlsClientKeyPath;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.tlsClientTrustCertPath;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.tlsServerAuthClient;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.tlsServerCertPath;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.tlsServerKeyPassword;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.tlsServerKeyPath;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.tlsServerNeedClientAuth;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.tlsServerTrustCertPath;
import static com.sundy.rocketmq.remoting.netty.TlsSystemConfig.tlsTestModeEnable;
...
public class TlsHelper {
	...
	public interface DecryptionStrategy {
		 ...
		 *
		 * @param privateKeyEncryptPath
		 *            A pathname string
		 * @param forClient
		 *            tells whether it's a client-side key file
	...
	public static SslContext buildSslContext(boolean forClient) throws IOException, CertificateException {
		...
		if (forClient) {
			if (tlsTestModeEnable) {
				...
				return sslContextBuilder.keyManager(!isNullOrEmpty(tlsClientCertPath) ? new FileInputStream(tlsClientCertPath) : null,
						!isNullOrEmpty(tlsClientKeyPath) ? decryptionStrategy.decryptPrivateKey(tlsClientKeyPath, true) : null, !isNullOrEmpty(tlsClientKeyPassword) ? tlsClientKeyPassword : null)
						.build();
			}
		} else {
			...
			if (tlsTestModeEnable) {
				...
				SslContextBuilder sslContextBuilder = SslContextBuilder.forServer(!isNullOrEmpty(tlsServerCertPath) ? new FileInputStream(tlsServerCertPath) : null,
						!isNullOrEmpty(tlsServerKeyPath) ? decryptionStrategy.decryptPrivateKey(tlsServerKeyPath, false) : null, !isNullOrEmpty(tlsServerKeyPassword) ? tlsServerKeyPassword : null)
						.sslProvider(provider);
