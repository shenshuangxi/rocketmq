...
public class TlsSystemConfig {
	 ...
	 * to client authentication. This configuration item really only applies
	 * when building the server-side {@link SslContext}, and can be set to none,
	 * require or optional.
	 */
	 ...
	 * enforcing. For client, use {@link TlsSystemConfig#tlsEnable} to determine
	 * whether use SSL.
	 * <ol>
	 ...
	 * <li><strong>enforcing:</strong> SSL is required, aka, non SSL connection
	 * will be rejected.</li>
	 * </ol>
	 */
